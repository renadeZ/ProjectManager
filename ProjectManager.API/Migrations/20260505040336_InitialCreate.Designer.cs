...
namespace ProjectManager.API.Migrations
{
    ...
    [Migration("20260505040336_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManager.API.Models.Job", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ProjectManager.API.Models.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProjectManager.API.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectManager.API.Models.Job", b =>
                {
                    b.HasOne("ProjectManager.API.Models.Team", "Team")
                        .WithMany("Jobs")
